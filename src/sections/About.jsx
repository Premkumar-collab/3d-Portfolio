...
const About = () => {
  ...
  const handleCopy = () => {
    navigator.clipboard.writeText("codewithredz@gmail.com")
        ...
        <div className="grid xl:grid-cols-3 xl:grid-rows-6 md:grid-cols-2 grid-cols-1 gap-5 h-full">
          <div className="col-span-1 xl:row-span-3">
            <div className="grid-container">
              ...
              <div>
                <p className='grid-headtext'>Hi,I'm Prem</p>
                <p className='grid-subtext'>With 1 years of exprerience, I have honed my skills in frontend and backend development, with a focus of animated 3D websites</p>
              </div>
            </div>
          </div>
          ...
          <div className='col-span-1 xl:row-span-4 relative'>
            <div className='grid-container'>
              ...
              <p className='grid-subtext'>I'm based in Bengaluru,with remote work available.</p>
              <a href="#contact">
            ...
            <div className="grid-container">
              ...
              <div className="space-y-2 text-center">
                ...
                <div className="copy-container" onClick={() => handleCopy}>
                  <img src={handleCopy ? 'assets/tick.svg' : 'assets/copy.svg'} alt="copy" />
                  <p className='lg:text-2xl md:text-xl font-medium text-gray_gradient text-white'>codewithredz@gmail.com</p>
                </div>
              </div>
            </div>
          </div>
